package com.bunga.pahlawannasional.main
...
import com.bunga.pahlawannasional.R
import com.bunga.pahlawannasional.detail.DetailActivity
import kotlinx.android.synthetic.main.list_nama_pahlawan.view.*


class MainAdapter(
    var context: Context,
    var modelMainList: MutableList<ModelMain>) : RecyclerView.Adapter<MainAdapter.MainViewHolder>(), Filterable {
